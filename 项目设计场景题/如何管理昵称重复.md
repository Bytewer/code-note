...
![image-1725899896295](./assets/image-1725899896295.png)
...
<font style="color:rgb(62, 62, 62);">当然也可以通过增加K个哈希个数，</font>![image-1725899896724](./assets/image-1725899896724.png)<font style="color:rgb(62, 62, 62);"> 或者增加bit位数组长度减少误判率。</font>
