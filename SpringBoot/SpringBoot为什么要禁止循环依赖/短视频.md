...
![image-1725898606669](./assets/image-1725898606669.png)
...
2. **<font style="color:#DF2A3F;">打破循环依赖</font>**，![image-1725898607127](./assets/image-1725898607127.png)把相互依赖的代码放在一个新的bean中， 这样就可以打破循环依赖的闭环
