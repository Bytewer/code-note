...
![image-1725897336982](./assets/image-1725897336982.png)
...
![image-1725897337288](./assets/image-1725897337288.png)
...
![image-1725897337655](./assets/image-1725897337655.png)
...
![image-1725897338094](./assets/image-1725897338094.png)
...
![image-1725897338529](./assets/image-1725897338529.png)
...
![image-1725897339984](./assets/image-1725897339984.png)
...
![image-1725897340313](./assets/image-1725897340313.png)
...
![image-1725897340614](./assets/image-1725897340614.png)
...
## ![image-1725897341037](./assets/image-1725897341037.png)  
...
![image-1725897341387](./assets/image-1725897341387.png)

而在 G1 回收器中，其将一大块的内存分为许多细小的区块，从而不要求内存是连续的。

![image-1725897341720](./assets/image-1725897341720.png)
...
![image-1725897342055](./assets/image-1725897342055.png)
...
![image-1725897342468](./assets/image-1725897342468.png)

上面是基于JDK17截图的Java工具集，已经删除了VisualVM了，在此我们基于GCEasy来进行GC日志分析。

官网地址为：[https://gceasy.io/](https://gceasy.io/) 它有在线分析版和离线分析版都可以使用～

![image-1725897342816](./assets/image-1725897342816.png)

![image-1725897343242](./assets/image-1725897343242.png)

![image-1725897343650](./assets/image-1725897343650.png)
...
![image-1725897344007](./assets/image-1725897344007.png)**如果满足下面的指标，则一般不需要进行GC：**
...
![image-1725897344477](./assets/image-1725897344477.png)
...
![image-1725897344828](./assets/image-1725897344828.png)  
再点击 **See stacktrace** 看看线程栈基本就能定位到问题代码了。

![image-1725897345217](./assets/image-1725897345217.png)
...
![image-1725897345592](./assets/image-1725897345592.png)

在 char[] 上点击右键，选择 List objects -> with incoming references，就可以列出所有的 char[] 实例，以及每个 char[] 的整个引用关系链：

![image-1725897345951](./assets/image-1725897345951.png)
...
![image-1725897346389](./assets/image-1725897346389.png)

如果希望看到完整内容的话，可以右键选择 Copy->Value，把值复制到剪贴板或保存到文件中：

![image-1725897346804](./assets/image-1725897346804.png)

### 线程栈 — 分析代码
可以点击工具栏的第五个按钮，打开线程视图来分析 OOMTest 执行什么逻辑。

![image-1725897347224](./assets/image-1725897347224.png)  
...
![image-1725897347576](./assets/image-1725897347576.png)

输入 help 命令，可以看到所有支持的命令列表。这里主要会用到 dashboard、thread、jad、watch 等命令，来定位高CPU的问题。

![image-1725897348095](./assets/image-1725897348095.png)

### dashboard — 展示整体情况
`dashboard` 命令整体展示了进程所有线程、内存、GC 等情况，可以明显看到两个CPU占用很高的线程，从线程名字来看应该是线程池的线程。

### ![image-1725897348496](./assets/image-1725897348496.png)  
thread — 查看高CPU的线程
...
### ![image-1725897348849](./assets/image-1725897348849.png)  
watch — 监控参数
如果想要观察方法的入参和出参，可以用 watch 命令来观察：

![image-1725897349310](./assets/image-1725897349310.png)

### jad — 反编译
![image-1725897349686](./assets/image-1725897349686.png)
...
![image-1725897350037](./assets/image-1725897350037.png)

然后修改下源码：添加了一行输出日志

![image-1725897350394](./assets/image-1725897350394.png)

2、使用 mc 命令反编译源文件

反编译后会生成对应的 class 文件：

![image-1725897350760](./assets/image-1725897350760.png)

3、使用 redefine 重载类

![image-1725897351138](./assets/image-1725897351138.png)

就可以看到控制台已经在输出我们打印的日志了：

![image-1725897351446](./assets/image-1725897351446.png)
