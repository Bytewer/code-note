...
![image-1725897429375](./assets/image-1725897429375.png)

我们来看看**RedisInsight**的效果图

![image-1725897429807](./assets/image-1725897429807.png)
...
## Redis基础数据结构-List类型
![image-1725897430167](./assets/image-1725897430167.png)
...
## Redis基础数据结构-Set类型
![image-1725897430576](./assets/image-1725897430576.png)
...
## ![image-1725897430876](./assets/image-1725897430876.png)
...
![image-1725897431388](./assets/image-1725897431388.png)

#### 非阻塞方式创建RDB文件
> 它区别于SAVE，它是由子进程通过异步方式执行的，它不会等待RDB文件生成完成之后再返回，而是直接返回OK，然后后台执行，那么在BGSAVE同步期间，Redis还是可以处理其他客户端的命令请求。
>

![image-1725897431873](./assets/image-1725897431873.png)
...
![image-1725897432269](./assets/image-1725897432269.png)
...
![image-1725897432748](./assets/image-1725897432748.png)
...
![image-1725897433123](./assets/image-1725897433123.jpeg)
...
![image-1725897433699](./assets/image-1725897433699.jpeg)
...
![image-1725897434079](./assets/image-1725897434079.jpeg)
...
### ![image-1725897434507](./assets/image-1725897434507.jpeg)  
...
![image-1725897435015](./assets/image-1725897435015.png)
...
![image-1725897435435](./assets/image-1725897435435.png)
