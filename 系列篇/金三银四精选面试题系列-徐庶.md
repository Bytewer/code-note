...
![image-1725897203406](./assets/image-1725897203406.png)
...
![image-1725897203739](./assets/image-1725897203739.png)

2. ThreadLocal底层是通过<font style="color:#2C3E50;">ThreadLocalMap来实现的，每个Thread对象（注意不是ThreadLocal对象）中都存在一个ThreadLocalMap，Map的key为ThreadLocal对象，Map的value为需要缓存的值</font>![image-1725897204074](./assets/image-1725897204074.png)
...
![image-1725897204403](./assets/image-1725897204403.png_x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_49%2Ctext_5Zu-54G16K--5aCC%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10%2Fresize%2Cw_937%2Climit_0)
...
![image-1725897204712](./assets/image-1725897204712.png)

**非公平锁的底层执行流程：**

![image-1725897205149](./assets/image-1725897205149.png)
...
![image-1725897205661](./assets/image-1725897205661.png)
...
![image-1725897206026](./assets/image-1725897206026.png)

a字段是主键，对应主键索引，bcd三个字段组成一个联合索引，e字段一个索引

### 1. 不符合最左匹配原则
![image-1725897206379](./assets/image-1725897206379.png)



去掉b=1的条件就不符合最左匹配原则了，导致所有失效

![image-1725897206753](./assets/image-1725897206753.png)

### 2. 不正确的Like查询
不用like能走索引：

![image-1725897207083](./assets/image-1725897207083.png)

正常使用like：

![image-1725897207445](./assets/image-1725897207445.png)

不正确使用like：

![image-1725897207795](./assets/image-1725897207795.png)



### 3. 对索引列进行了计算或使用了函数
![image-1725897208086](./assets/image-1725897208086.png)



![image-1725897208459](./assets/image-1725897208459.png)
...
![image-1725897208813](./assets/image-1725897208813.png)
...
![image-1725897209112](./assets/image-1725897209112.png)
...
![image-1725897209468](./assets/image-1725897209468.png)



如果是select b就需要回表了，就会选择走索引

![image-1725897209876](./assets/image-1725897209876.png)

### 7. 使用or导致索引失效


![image-1725897210190](./assets/image-1725897210190.png)

### 8. select * 导致索引失效
![image-1725897210558](./assets/image-1725897210558.png)
...
![image-1725897210896](./assets/image-1725897210896.png)
...
![image-1725897211207](./assets/image-1725897211207.webp)     ![image-1725897211502](./assets/image-1725897211502.png)
